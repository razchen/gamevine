  ...
  return (
    <>
      <PageHeader
        eyebrow="Primitives"
        title="Toggle"
        description="Pressable button with a sticky on/off state. Use a single Toggle for boolean affordances (bold / italic / pin). Use ToggleGroup when exactly one of several options should be selected (alignment, view mode)."
      />
