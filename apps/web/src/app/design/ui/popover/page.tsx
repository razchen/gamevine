  ...
  return (
    <>
      <header className="flex flex-col gap-1">
        <h1 className="text-foreground text-2xl font-semibold tracking-tight">Popover</h1>
        <p className="text-muted-foreground text-sm">
          Anchored content for settings, filters, peeks. Portaled, so previews render in the live
          theme only.
        </p>
      </header>
