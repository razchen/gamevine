  ...
  return (
    <>
      <PageHeader
        eyebrow="Primitives"
        title="Skeleton"
        description="Animated placeholders that preserve final layout. Tinted with --muted-foreground at 20% alpha so they stay legible on any surface in both themes."
      />
