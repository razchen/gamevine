...
export const UI_NAV: UiNavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        blurb: 'Shadcn react-hook-form bridge: Form, FormField, FormItem, FormLabel, FormMessage.',
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      {
        href: '/design/ui/form-field',
        label: 'Form field',
        icon: BookTextIcon,
        blurb: 'One-line wrapper over the shadcn Form set with RHF + zod validation.',
      },
      {
        href: '/design/ui/prose',
        label: 'Prose',
        icon: TypeIcon,
        blurb: 'Long-form text container with the prose-gv tint over @tailwindcss/typography.',
      },
      {
        href: '/design/ui/data-table',
        label: 'Data table',
        icon: Table2Icon,
        blurb: 'TanStack table on the shadcn Table primitive: sort, filter, paginate.',
      },
    ],
  },
];
