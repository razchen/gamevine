...
1. **Overview:** `.claude/skills/vercel-react-best-practices/SKILL.md`
2. **Full guide:** `.claude/skills/vercel-react-best-practices/AGENTS.md`
3. **Individual rules as needed:** `.claude/skills/vercel-react-best-practices/rules/<rule-name>.md`
