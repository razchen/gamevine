...
2. **Context7 MCP**: use the Context7 MCP server for React 19, Next.js 16, and any other library the question touches. Use when the installed docs don't cover the topic or when you want a second source.
