...
- `CallMcpTool` with server `user-Sentry` — pull the issue, events, stack trace, and user context. Read the tool descriptors under `/Users/r/.cursor/projects/Users-r-code-mine-gamevine/mcps/user-Sentry/tools/` BEFORE calling.
